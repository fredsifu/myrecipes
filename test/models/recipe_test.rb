...
class RecipeTest < ActiveSupport::TestCase
  def setup
    @chef = Chef.create(name: "Bob", email: "bob@bob.com") # sandbox mode on test db
    @recipe = @chef.recipes.build(name: "Chicken parm", summary: "This is the best parm recipe ever",
